    ...
    ACPI_NAMESPACE_NODE     *Node)
{
    ...
    /*
     * Delete an attached data object list if present (an object that was
     * created and attached via AcpiAttachData). Note: After any normal object
     * is detached above, the only possible remaining object is a data object.
     */
    ObjDesc = Node->Object;
    while (ObjDesc &&
